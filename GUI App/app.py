...
canvas = tk.Canvas(root, height=700, width=700, bg="#263D42").pack() #pack the canvas to the root so it can be seen
...
outputBox = tk.Text(frame, height=50, width=50, borderwidth=5)
outputBox.pack()
# ----------------- Text Box Section -----------------
